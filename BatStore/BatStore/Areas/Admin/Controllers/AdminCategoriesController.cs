...
namespace BatStore.Areas.Admin.Controllers
{
    ...
    public class AdminCategoriesController : Controller
    {
        ...
        public AdminCategoriesController(dbBatStoreContext context, INotyfService notyfService)
        {
            _context = context;
        ...
        public IActionResult Index(int? page)
        {
            ...
            var pageSize = 20;
            var lsCategory = _context.Categories.AsNoTracking().OrderByDescending(x => x.CatId);
