...
namespace BatStore.Areas.Admin.Controllers
{
    ...
    public class AdminOrdersController : Controller
    {
        ...
        public AdminOrdersController(dbBatStoreContext context, INotyfService notifyfService)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("OrderId,CustomerId,OrderDate,ShipDate,TransactStatusId,Paid,PaymentDate,TotalMoney,PaymentId,Note,Address")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderId,CustomerId,OrderDate,ShipDate,TransactStatusId,Paid,PaymentDate,TotalMoney,PaymentId,Note,Address")] Order order)
        {
            if (id != order.OrderId)
            {
                return NotFound();
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            var Chitietdonhang = _context.OrderDetails
               ...
               .ToList();
            ViewBag.Details = Chitietdonhang;
            ViewBag.FullAdress = order.Address;
            return View(order);
        }
